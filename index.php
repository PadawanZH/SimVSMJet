...
require_once 'Class/Func/DocumentQuery.php';
require_once 'Class/Func/WordItem.php';

$arr = array();

$item = new WordItem("马克西莫夫", 15, 0.1, 0.01, "n");
array_push($arr, $item);
$item = new WordItem("斯维尔德洛夫斯克州", 27, 0.1, 0.01, "n");
array_push($arr, $item);

$dq = new DocumentQuery($arr);
var_dump($dq->getDocuments());